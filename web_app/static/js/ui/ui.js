                ...
                if (coloringResult) {
                    ...
                    colorGroups.forEach((groupNodes, colorIndex) => {
                        ...
                        groupNodes.forEach(node => {
                            ...
                            el.onmouseenter = () => { node.highlight = true; import('../engine/rendering/render.js').then(r => r.draw()); };
                            el.onmouseleave = () => { node.highlight = false; import('../engine/rendering/render.js').then(r => r.draw()); };
                            elements.resultsList.appendChild(el);
                        });
                    });
                }
