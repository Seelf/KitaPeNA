...
import { toWorld, toScreen } from '../rendering/render.js';
...
import { runForceDirectedLayout } from '../layout/layout_engine.js';

export function runAutoLayout() {
    const all = [...places, ...transitions];

    runForceDirectedLayout(all, arcs, {
        iterations: 100,
        k: 100,
        isPetri: true,
        snapToGrid: petriState.snapToGrid,
        onUpdate: () => {
            camera.x = 0;
            camera.y = 0;
            camera.zoom = 1;
